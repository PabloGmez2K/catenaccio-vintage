...
- [ ] **S023D — PLAYER_TERM_RESOLUTION** — **NEXT / SIGUIENTE BLOQUE RECOMENDADO.** Aplicar caché + creación a `pa_jugador`; resolver Rivaldo. Agente Sonnet. Gate: `FULL_FIXTURE` con jugador. Cierra el fallo diferido de S022C.8: Jugador aparece seleccionado en WP Admin.
