...
- [ ] **S022 — STUDIO_CREATE_AND_PUBLISH** — NEXT / UNBLOCKED tras S021C. Formulario alta camiseta (inventory_items + football_shirt_details) + "Sugerir con Claude" (Anthropic API) + botón "Crear borrador en WC". (Sonnet/Codex)
