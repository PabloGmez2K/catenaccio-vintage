...
- [ ] **STUDIO_TEST_PRODUCT_CLEANUP** — Pablo verifica en WP Admin → Productos → Borradores el producto `[STUDIO TEST]` ID 1853 y lo elimina manualmente. No ejecutar DELETE por API salvo autorización explícita posterior.
