...
- [ ] **S022 — STUDIO_CREATE_AND_PUBLISH** — NEXT / UNBLOCKED tras S021B. Formulario alta camiseta (inventory_items + football_shirt_details) + "Sugerir con Claude" (Anthropic API) + botón "Crear borrador en WC". `WORKSPACE_SEED_MANUAL` sigue pendiente para ver datos reales. (Sonnet/Codex)
