...
- [~] **S022C — STUDIO_WC_DRAFT_BRIDGE** — **READY_FOR_PABLO_NEW_DRAFT_TEST (2026-06-28, Sonnet S022C.6).** Hito E2E validado: borrador 1854 (PSV Away 2007-09) creado en WooCommerce. S022C.5: auditoría de publicabilidad → 10 gaps detectados. S022C.6: payload v2.0 implementado: ACF field keys, `ano_temporada` array, medidas, defectos, categorías automáticas, `manage_stock: true + stock_quantity: 1`, HTML en `descripcion_del_producto`. typecheck/build/lint PASS. **Pendiente (acción Pablo):** crear nuevo item de prueba en Studio, completar campos incluyendo medidas y notas, aprobar contenido SEO manual, pulsar "Crear borrador en WooCommerce" 1 vez, verificar en WP Admin que "Detalles del Producto" muestra Liga/Equipo/Año correctamente. Ver `docs/studio/STUDIO_WC_DRAFT_BRIDGE_RESULT.md §S022C.6`.
- [ ] **S023 — STUDIO_WC_TAXONOMY_AND_CATEGORY_MANAGER** — Gestión propia desde Studio de atributos, términos y categorías WooCommerce. Incluye: (1) selector de categoría en UI para Leyendas/Nuevo/Otros/Selecciones; (2) create/sync términos pa_equipo/pa_liga/pa_ano/pa_jugador sin pasar por WP Admin; (3) read/sync bidireccional de términos; (4) batch-PATCH de productos con payload v2.0 (incluyendo corrección producto 1854). Ver `docs/studio/STUDIO_WC_DRAFT_PUBLISHABILITY_GAP_AUDIT.md §QUÉ DEBE QUEDAR PARA S023`.
