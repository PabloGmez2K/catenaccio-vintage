...
- [ ] **S021 — STUDIO_MVP_SCAFFOLD** — NEXT / UNBLOCKED. App Next.js + Supabase en Vercel; auth Pablo; vista inventario. Prerequisitos completados: WC_API_WRITE_ACCESS_TEST PASS + schema Supabase aplicado. (Sonnet/Codex)
