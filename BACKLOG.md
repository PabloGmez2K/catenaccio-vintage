...
- [ ] **S022A — STUDIO_CREATE_ITEM_FORM** — NEXT / UNBLOCKED. Formulario de alta (`inventory_items` + `football_shirt_details`) vía Server Action; lectura de vuelta en inventario+detalle; exigir campos NOT NULL que el contrato WC requiere. Sin Claude, sin WC, sin deploy. Parada: Pablo crea ≥1 camiseta real por formulario en local. Veredicto esperado: `APPROVE_READY_FOR_S022B`. (Sonnet/Codex)
