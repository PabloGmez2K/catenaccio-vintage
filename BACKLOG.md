...
- [ ] **S022B — STUDIO_AI_SUGGESTIONS_SHADOW** — **NEXT / UNBLOCKED por PABLO_LOCAL_FORM_OK (2026-06-28).** "Sugerir con Claude" (Anthropic API, server-side only) → `ai_suggestions` versionada → Pablo aprueba/edita. SHADOW_FIRST: nunca fluye sola a WC. Sin WC, sin deploy. Parada: Pablo aprueba una sugerencia para la camiseta de S022A. Veredicto esperado: `APPROVE_READY_FOR_S022C`. (Sonnet)
