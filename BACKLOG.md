...
- [ ] **S025–S030 — SUITE ROADMAP** — S025 (imagenes) queda como siguiente bloque recomendado, no abierto. Despues: stock operativo (S026), Rank Math/SEO (S027), landings (S028), drift detection (S029), publicacion controlada (S030). Una tarea por sesion, gates por fase. Ver `docs/studio/STUDIO_ROADMAP_S023_S030.md §3` y matriz de gates `docs/studio/STUDIO_SESSION_GATES.md §7`.
