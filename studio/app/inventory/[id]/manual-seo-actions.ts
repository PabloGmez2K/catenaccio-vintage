...
// The web price is NOT set from here anymore: it lives in Editar → «Precio y
// coste» (STUDIO_OPERATIVE_EDIT_SURFACE). precio_sugerido, when present, is
// stored on the suggestion as reference only.
